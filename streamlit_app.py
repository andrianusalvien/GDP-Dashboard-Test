...
# --- ISLAND SECTION ---
st.subheader("🏝️ Explore Penguin Islands")

# Checkbox untuk show map / show gallery
show_map = st.checkbox("Show Map", value=True)

# --- DATA KOORDINAT ISLAND ---
island_coords = {
    "Torgersen": {"lat": -64.7667, "lon": -64.0833},
    "Biscoe": {"lat": -65.4333, "lon": -65.5833},
    "Dream": {"lat": -64.7333, "lon": -64.2333},
}

# --- GAMBAR ISLAND ---
island_images = {
    "Torgersen": "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Torgersen_Island_in_Antarctica.jpg/640px-Torgersen_Island_in_Antarctica.jpg",
    "Biscoe": "https://upload.wikimedia.org/wikipedia/commons/7/7d/Biscoe_Bay_Antarctica.jpg",
    "Dream": "https://upload.wikimedia.org/wikipedia/commons/6/68/Dream_Island_Antarctica.jpg"
}

# --- SHOW MAP ---
if show_map:
    st.markdown("### 🌍 Map of Islands")
    island_df = pd.DataFrame.from_dict(island_coords, orient="index")

    if island:
        map_data = island_df.loc[island]
    else:
        map_data = island_df
